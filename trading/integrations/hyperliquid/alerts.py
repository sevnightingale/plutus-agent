...
def poll_hl_prediction_resolution(
    ...
    # Status sync (test↔active) runs inside resolve_open_predictions after any
    # resolution — shared with the ops safety-net path so neither caller can
    # leave tradeable/status mismatched when the other is down.
