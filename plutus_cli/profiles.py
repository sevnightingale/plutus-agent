...
Profiles live under ``~/.plutus-agent/profiles/<name>/`` by default.
...
_PROFILE_DIRS = [
    ...
    # See plutus_constants.get_subprocess_home() and issue #4426.
    "home",
]
...
def set_active_profile(name: str) -> None:
    ...
    Writes to ``~/.plutus-agent/active_profile``. Use ``"default"`` to clear.
    """
    validate_profile_name(name)
...
def generate_bash_completion() -> str:
    ...
    return '''# plutus-agent profile completion
...
# plutus-agent profile completion
