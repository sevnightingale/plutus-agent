...
TIPS = [
    ...
    "SOUL.md at ~/.plutus-agent/SOUL.md is the agent's primary identity — customize it to shape behavior.",
    ...
    "SOUL.md is auto-seeded with a default personality on first run. Edit ~/.plutus-agent/SOUL.md to customize.",
