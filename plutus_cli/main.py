...
def _require_tty(command_name: str) -> None:
    ...
    Interactive TUI commands (hermes tools, plutus setup, plutus model) use
...
def _apply_profile_override() -> None:
    ...
    if profile_name is not None:
        try:
            from plutus_cli.profiles import resolve_profile_env
...
try:
    from plutus_logging import setup_logging as _setup_logging
...
try:
    from plutus_cli.config import load_config as _load_config_early
    from plutus_constants import apply_ipv4_preference as _apply_ipv4
...
from plutus_constants import AI_GATEWAY_BASE_URL, OPENROUTER_BASE_URL
...
def _has_any_provider_configured() -> bool:
    ...
    from plutus_cli.config import get_env_path, get_hermes_home, load_config
    from plutus_cli.auth import get_auth_status
...
def cmd_chat(args):
    ...
    try:
        from plutus_cli.banner import prefetch_update_check
...
def cmd_gateway(args):
    ...
    from plutus_cli.gateway import gateway_command
...
def cmd_whatsapp(args):
    ...
    from plutus_cli.config import get_env_value, save_env_value
...
def cmd_setup(args):
    ...
    from plutus_cli.setup import run_setup_wizard
...
def select_provider_and_model(args=None, *, quick=False):
    ...
    from plutus_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
...
def _clear_stale_openai_base_url():
    ...
    """
    from plutus_cli.config import get_env_value, save_env_value, load_config
...
def _aux_flow_provider_model(
    ...
    from plutus_cli.models import get_pricing_for_provider
...
def _prompt_provider_choice(choices, *, default=0):
    ...
    """
    try:
        from plutus_cli.setup import _curses_prompt_choice
...
def _model_flow_openrouter(config, current_model=""):
    ...
    from plutus_cli.models import model_ids, get_pricing_for_provider
...
def _model_flow_ai_gateway(config, current_model=""):
    ...
    from plutus_cli.models import ai_gateway_model_ids, get_pricing_for_provider
...
def _model_flow_nous(config, current_model="", args=None):
    ...
    from plutus_cli.nous_subscription import prompt_enable_tool_gateway
    ...
    if free_tier and not model_ids:
        ...
        if unavailable_models:
            from plutus_cli.auth import DEFAULT_NOUS_PORTAL_URL
...
def _model_flow_qwen_oauth(_config, current_model=""):
    ...
    from plutus_cli.models import fetch_api_models
...
def _model_flow_custom(config):
    ...
    """
    from plutus_cli.auth import _save_model_choice, deactivate_provider
    from plutus_cli.config import get_env_value, load_config, save_config
    ...
    from plutus_cli.models import probe_api_models
...
def _model_flow_copilot(config, current_model=""):
    ...
    from plutus_cli.config import save_env_value, load_config, save_config
    from plutus_cli.models import (
        fetch_api_models,
    ...
    if not api_key:
        ...
        if choice == "1":
            try:
                from plutus_cli.copilot_auth import copilot_device_code_login
            ...
            # Validate token type
            try:
                from plutus_cli.copilot_auth import validate_copilot_token
...
def _model_flow_stepfun(config, current_model=""):
    ...
    from plutus_cli.config import get_env_value, save_env_value, load_config, save_config
    from plutus_cli.models import fetch_api_models
...
def cmd_login(args):
    ...
    from plutus_cli.auth import login_command
...
def cmd_logout(args):
    ...
    from plutus_cli.auth import logout_command
...
def cmd_auth(args):
    ...
    from plutus_cli.auth_commands import auth_command
...
def cmd_cron(args):
    """Cron job management."""
    from plutus_cli.cron import cron_command
...
def cmd_webhook(args):
    ...
    from plutus_cli.webhook import webhook_command
...
def cmd_hooks(args):
    ...
    from plutus_cli.hooks import hooks_command
    hooks_command(args)


def cmd_doctor(args):
    """Check configuration and dependencies."""
    from plutus_cli.doctor import run_doctor
...
def cmd_debug(args):
    ...
    from plutus_cli.debug import run_debug
...
def cmd_config(args):
    ...
    from plutus_cli.config import config_command
...
def cmd_backup(args):
    ...
    if getattr(args, "quick", False):
        from plutus_cli.backup import run_quick_backup

        run_quick_backup(args)
    else:
        from plutus_cli.backup import run_backup
...
def cmd_import(args):
    ...
    from plutus_cli.backup import run_import
...
def cmd_uninstall(args):
    ...
    from plutus_cli.uninstall import run_uninstall
...
def _install_hangup_protection(gateway_mode: bool = False):
    ...
    **intentionally left alone** — those are legitimate cancellation
    ...
    try:
        ...
        from plutus_cli.config import get_hermes_home as _get_hermes_home
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        try:
            import importlib
            import plutus_constants as _hc
...
def cmd_profile(args):
    ...
    if action == "list":
        ...
        from plutus_cli.profiles import profile_exists
        ...
        from plutus_cli.profiles import rename_profile
        ...
        from plutus_cli.profiles import export_profile
        ...
        from plutus_cli.profiles import import_profile
...
def cmd_dashboard(args):
    ...
    from plutus_cli.web_server import start_server
...
def cmd_completion(args, parser=None):
    ...
    from plutus_cli.completion import generate_bash, generate_zsh, generate_fish
...
def cmd_logs(args):
    ...
    from plutus_cli.logs import tail_log, list_logs
...
""",
    ...
    # =========================================================================
    from plutus_cli.lifecycle import add_lifecycle_subparser
    add_lifecycle_subparser(subparsers)

    # =========================================================================
    # setup-status command (plutus-agent Phase 4 — at-a-glance dashboard)
    # =========================================================================
    from plutus_cli.setup_status import add_setup_status_subparser
...
""",
    ...
    def cmd_pairing(args):
        from plutus_cli.pairing import pairing_command
    ...
    def cmd_skills(args):
        ...
        if getattr(args, "skills_action", None) == "config":
            ...
            from plutus_cli.skills_config import skills_command as skills_config_command

            skills_config_command(args)
        else:
            from plutus_cli.skills_hub import skills_command
    ...
    def cmd_plugins(args):
        from plutus_cli.plugins_cmd import plugins_command
    ...
    def cmd_sessions(args):
        ...
        if action == "list":
            ...
            if hermes_bin:
                ...
                os.execvp(
                    sys.executable,
                    [sys.executable, "-m", "plutus_cli.main", "--resume", selected_id],
                )
    ...
    def cmd_claw(args):
        from plutus_cli.claw import claw_command
...
""",
    ...
    from plutus_cli.config import get_container_exec_info
