...
from harness.tools.environments.base import BaseEnvironment, _popen_bash
...
def _load_hermes_env_vars() -> dict[str, str]:
    """Load ~/.plutus-agent/.env values without failing Docker command execution."""
    try:
        from harness.cli.config import load_env
...
class DockerEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        # (TERMINAL_SANDBOX_DIR, default ~/.plutus-agent/sandboxes/). Non-persistent
