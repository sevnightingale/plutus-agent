...
from harness.tools.environments.base import _file_mtime_key
...
class FileSyncManager:
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        ``~/.plutus-agent/skills/a.md``, a new remote file at
        ``/root/.hermes/skills/b.md`` maps to ``~/.plutus-agent/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
        for host, remote in mapping:
