...
Used by plutus_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
class OptionalSkillSource(SkillSource):
    ...
    ~/.plutus-agent/skills/ during setup.  They are discoverable via the Skills Hub
...
HERMES_INDEX_URL = "https://github.com/sevnightingale/plutus-agent/api/skills-index.json"
