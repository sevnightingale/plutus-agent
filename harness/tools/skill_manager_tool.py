...
~/.plutus-agent/skills/. Existing skills (bundled, hub-installed, or user-created)
...
def _guard_agent_created_enabled() -> bool:
    ...
    on via `plutus config set skills.guard_agent_created true`.
    """
    try:
...
# All skills live in ~/.plutus-agent/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.plutus-agent/skills/) first, then any
