...
DANGEROUS_PATTERNS = [
    ...
    (r'\bhermes\s+gateway\s+(stop|restart)\b', "stop/restart plutus gateway (kills running agents)"),
    (r'\bhermes\s+update\b', "plutus update (restarts gateway, kills running agents)"),
