...
from harness.agent.gemini_schema import sanitize_gemini_tool_parameters
from harness.agent.google_code_assist import (
...
def _gemini_http_error(response: httpx.Response) -> CodeAssistError:
    ...
    if status == 429 and error_reason == "MODEL_CAPACITY_EXHAUSTED":
        ...
        message = (
            ...
            f"retired. Check plutus_cli/models.py for the current list."
        )
    elif err_message:
