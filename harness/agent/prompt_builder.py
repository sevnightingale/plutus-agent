...
DEFAULT_AGENT_IDENTITY = (
    "You are plutus-agent, an autonomous trading agent. Trading is your domain — "
    "you analyze markets, develop and test theses, execute trades, and learn from "
    "outcomes, collaborating with your operator, who sets capital and risk posture "
    "while you handle the analysis, decisions, and execution. You are direct and "
    "honest about uncertainty, and you prioritize being genuinely useful over being "
...
def build_skills_system_prompt(
    ...
    scanned alongside the local ``~/.plutus-agent/skills/`` directory.  External dirs
...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    lines.extend(
        [
            ...
            "Useful commands: plutus setup, plutus setup tools, plutus setup terminal, plutus status.",
        ]
    )
    return "\n".join(lines)
