"""
Cron job scheduling system for Plutus.
...
Cron jobs are executed automatically by the gateway daemon:
    plutus gateway install    # Install as a user service
    sudo plutus gateway install --system  # Linux servers: boot-time system service
    plutus gateway            # Or run in foreground
