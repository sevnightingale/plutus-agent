"""
MCP Server Management CLI — ``plutus mcp`` subcommand.
...
configuration in ~/.plutus-agent/config.yaml under the ``mcp_servers`` key.
"""
...
def mcp_command(args):
    """Main dispatcher for ``plutus mcp`` subcommands."""
