...
def cron_list(show_all: bool = False):
    ...
    if not jobs:
        ...
        print(color("Create one with 'plutus cron create ...' or the /cron command in chat.", Colors.DIM))
        return
    ...
    if not find_gateway_pids():
        ...
        print(color("                    sudo plutus gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    plutus gateway install    # Install as a user service")
        print("    sudo plutus gateway install --system  # Linux servers: boot-time system service")
        print("    plutus gateway            # Or run in foreground")
