...
def _setup_hint() -> str:
  ...
  Then start the gateway: plutus gateway run
"""
...
def _cmd_subscribe(args):
    ...
    print(f"  The gateway must be running to receive events (plutus gateway run).\n")
...
def _cmd_test(args):
    ...
    try:
        ...
        print(f"  Error: {e}")
        print("  Is the gateway running? (plutus gateway run)")
