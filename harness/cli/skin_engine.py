"""plutus-agent CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.plutus-agent/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "plutus-agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ◆"              # Shown on exit
      response_label: " ◆ plutus-agent "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "plutus-agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.plutus-agent/skins/
...
Drop a YAML file in ``~/.plutus-agent/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "plutus-agent",
            "welcome": "Welcome to plutus-agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ◆",
            "response_label": " ◆ plutus-agent ",
            "prompt_symbol": "❯ ",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "plutus-agent": {
        "name": "plutus-agent",
        "description": "plutus-agent — analytical charcoal + amber trading aesthetic",
        "colors": {
            "banner_border": "#3D5A80",      # deep slate blue
            "banner_title": "#FFB627",       # amber accent
            "banner_accent": "#EE6C4D",      # decisive orange
            "banner_dim": "#293241",         # deep charcoal
            "banner_text": "#E0FBFC",        # cool cream
            "ui_accent": "#FFB627",
            "ui_label": "#98C1D9",           # soft slate
            "ui_ok": "#06A77D",              # subtle P&L green
            "ui_error": "#D62828",           # subtle P&L red
            "ui_warn": "#FFB627",
            "prompt": "#E0FBFC",
            "input_rule": "#3D5A80",
            "response_border": "#FFB627",
            "status_bar_bg": "#1A1F25",
            "status_bar_text": "#E0FBFC",
            "status_bar_strong": "#FFB627",
            "status_bar_dim": "#5A6478",
            "status_bar_good": "#06A77D",
            "status_bar_warn": "#FFB627",
            "status_bar_bad": "#EE6C4D",
            "status_bar_critical": "#D62828",
            "session_label": "#98C1D9",
            "session_border": "#3D5A80",
        },
        "spinner": {},
        "branding": {
            "agent_name": "plutus-agent",
            "welcome": "plutus-agent — autonomous trading agent. Type your message or /help.",
            "goodbye": "Markets close, agents continue.",
            "response_label": " ◆ plutus-agent ",
            "prompt_symbol": "› ",
