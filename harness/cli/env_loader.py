...
def _sanitize_loaded_credentials() -> None:
    ...
    for key, value in list(os.environ.items()):
        ...
        print(
            ...
            "  provider's dashboard and run `plutus setup` (or edit the "
...
def _sanitize_env_file_if_needed(path: Path) -> None:
    ...
    We delegate to ``plutus_cli.config._sanitize_env_lines`` which
...
def load_hermes_dotenv(
    *,
    ...
    Behavior:
    - `~/.plutus-agent/.env` overrides stale shell-exported values when present.
