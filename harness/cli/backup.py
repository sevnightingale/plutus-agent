...
from harness.constants import get_default_hermes_root, get_hermes_home, display_hermes_home
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        if profiles_dir.is_dir():
            try:
                ...
                # plutus_cli.profiles might not be available (fresh install)
        ...
        if not (hermes_root / "hermes-agent").is_dir():
            ...
            print("  If this is a fresh install, run: plutus update")
