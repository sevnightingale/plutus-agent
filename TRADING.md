...
|---|---|---|
| `equity_usd` | `spot_usdc + perp_account_value` — **THE account-worth number** for the whole unified cross-margin account | sizing base (notional bands), Live State snapshot, drawdown, the balance-change alert |
