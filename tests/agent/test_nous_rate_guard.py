...
class TestRecordNousRateLimit:
    ...
    def test_records_with_header_reset(self, rate_guard_env):
        from harness.agent.nous_rate_guard import record_nous_rate_limit, _state_path
...
class TestNousRateLimitRemaining:
    ...
    def test_returns_remaining_seconds_when_active(self, rate_guard_env):
        from harness.agent.nous_rate_guard import record_nous_rate_limit, nous_rate_limit_remaining
    ...
    def test_returns_none_when_expired(self, rate_guard_env):
        from harness.agent.nous_rate_guard import nous_rate_limit_remaining, _state_path
...
class TestFormatRemaining:
    ...
    def test_seconds(self):
        from harness.agent.nous_rate_guard import format_remaining
...
class TestParseResetSeconds:
    ...
    def test_case_insensitive_headers(self, rate_guard_env):
        from harness.agent.nous_rate_guard import _parse_reset_seconds
