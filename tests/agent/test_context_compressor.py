...
from harness.agent.context_compressor import ContextCompressor, SUMMARY_PREFIX


@pytest.fixture()
def compressor():
    """Create a ContextCompressor with mocked dependencies."""
    with patch("harness.agent.context_compressor.get_model_context_length", return_value=100000):
        c = ContextCompressor(
            model="test/model",
...
class TestGenerateSummaryNoneContent:
    ...
    def test_none_content_does_not_crash(self):
        ...
        with patch("harness.agent.context_compressor.call_llm", return_value=mock_response):
...
class TestNonStringContent:
    ...
    def test_summary_call_does_not_force_temperature(self):
        ...
        with patch("harness.agent.context_compressor.call_llm", return_value=mock_response) as mock_call:
...
class TestSummaryFailureCooldown:
    def test_summary_failure_enters_cooldown_and_skips_retry(self):
        ...
        with patch("harness.agent.context_compressor.call_llm", side_effect=Exception("boom")) as mock_call:
...
class TestSummaryTargetRatio:
    ...
    def test_ratio_clamped(self):
        ...
        with patch("harness.agent.context_compressor.get_model_context_length", return_value=100_000):
...
class TestTruncateToolCallArgsJson:
    ...
    def _helper(self):
        from harness.agent.context_compressor import _truncate_tool_call_args_json
    ...
    def test_shrunken_args_remain_valid_json(self):
        ...
        original = _json.dumps({
            "path": "~/.plutus-agent/skills/shopping/browser-setup-notes.md",
        ...
        assert parsed["path"] == "~/.plutus-agent/skills/shopping/browser-setup-notes.md"
