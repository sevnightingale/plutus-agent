...
class TestMinimaxBetaHeaders:
    ...
    def _build_and_get_betas(self, api_key, base_url=None):
        ...
        with patch("harness.agent.anthropic_adapter._anthropic_sdk") as mock_sdk:
    ...
    def test_common_betas_none_url(self):
        from harness.agent.anthropic_adapter import _common_betas_for_base_url, _COMMON_BETAS
    ...
    def test_common_betas_minimax_url(self):
        from harness.agent.anthropic_adapter import _common_betas_for_base_url, _TOOL_STREAMING_BETA
...
class TestMinimaxSwitchModelCredentialGuard:
    ...
    def test_switch_to_minimax_does_not_resolve_anthropic_token(self):
        ...
        with patch("harness.agent.anthropic_adapter.build_anthropic_client") as mock_build, \
             patch("harness.agent.anthropic_adapter.resolve_anthropic_token", return_value="sk-ant-leaked") as mock_resolve, \
             patch("harness.agent.anthropic_adapter._is_oauth_token", return_value=False):
