...
def test_custom_endpoint_anthropic_messages_builds_anthropic_wrapper():
    ...
    from harness.agent.auxiliary_client import _try_custom_endpoint, AnthropicAuxiliaryClient

    with patch(
        "harness.agent.auxiliary_client._resolve_custom_runtime",
        return_value=(
...
def test_custom_endpoint_anthropic_messages_falls_back_when_sdk_missing():
    ...
    from harness.agent.auxiliary_client import _try_custom_endpoint
    ...
    from harness.agent.auxiliary_client import AnthropicAuxiliaryClient
