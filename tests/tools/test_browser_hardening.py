...
class TestCommandTimeoutCache:
    ...
    def test_default_is_30(self):
        from harness.tools.browser_tool import _get_command_timeout
        with patch("harness.cli.config.read_raw_config", return_value={}):
    ...
    def test_cached_after_first_call(self):
        ...
        with patch("harness.cli.config.read_raw_config", mock_read):
...
class TestHomebrewNodeDirsCache:
    ...
    def test_lru_cached(self):
        from harness.tools.browser_tool import _discover_homebrew_node_dirs
...
class TestTruncateSnapshot:
    ...
    def test_short_snapshot_unchanged(self):
        from harness.tools.browser_tool import _truncate_snapshot
