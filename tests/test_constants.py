"""Tests for plutus_constants module."""
...
class TestGetDefaultHermesRoot:
    ...
    def test_no_hermes_home_returns_native(self, tmp_path, monkeypatch):
        """When HERMES_HOME is not set, returns ~/.plutus-agent."""
        monkeypatch.delenv("HERMES_HOME", raising=False)
        monkeypatch.delenv("PLUTUS_HOME", raising=False)
        monkeypatch.setattr(Path, "home", lambda: tmp_path)
        assert get_default_hermes_root() == tmp_path / ".plutus-agent"
...
class TestIsContainer:
    ...
    def _reset_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(plutus_constants, "_container_detected", None)
    ...
    def test_caches_result(self, monkeypatch):
        ...
        monkeypatch.setattr(plutus_constants, "_container_detected", True)
        assert is_container() is True
