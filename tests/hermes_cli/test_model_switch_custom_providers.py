...
import plutus_cli.providers as providers_mod
from plutus_cli.model_switch import list_authenticated_providers, switch_model
from plutus_cli.providers import resolve_provider_full
...
def test_switch_model_accepts_explicit_named_custom_provider(monkeypatch):
    ...
    monkeypatch.setattr("plutus_cli.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
    monkeypatch.setattr("plutus_cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("plutus_cli.model_switch.get_model_capabilities", lambda *a, **k: None)
