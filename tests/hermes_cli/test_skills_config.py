...
class TestSaveDisabledSkills:
    @patch("plutus_cli.skills_config.save_config")
    def test_saves_global_sorted(self, mock_save):
        from plutus_cli.skills_config import save_disabled_skills
        config = {}
...
class TestIsSkillDisabled:
    @patch("plutus_cli.config.load_config")
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from plutus_cli.skills_config import _get_categories
        skills = [
