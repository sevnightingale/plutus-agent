"""Tests for plutus_cli.web_server and related config utilities."""
...
class TestWebServerEndpoints:
    ...
    def test_path_traversal_dotdot_blocked(self):
        ...
        resp = self.client.get("/%2e%2e/plutus_cli/web_server.py")
        assert resp.status_code in (200, 404)
        if resp.status_code == 200:
...
class TestDiscoverUserThemes:
    """Tests for _discover_user_themes() — scans ~/.plutus-agent/dashboard-themes/."""
