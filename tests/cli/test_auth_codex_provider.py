"""Tests for Codex auth — tokens stored in Hermes auth store (~/.plutus-agent/auth.json)."""
...
def test_resolve_codex_runtime_credentials_refreshes_expiring_token(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("harness.cli.auth._refresh_codex_auth_tokens", _fake_refresh)
