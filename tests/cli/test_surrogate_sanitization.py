...
class TestRunConversationSurrogateSanitization:
    ...
    @patch("harness.run_agent.AIAgent._build_system_prompt")
    @patch("harness.run_agent.AIAgent._interruptible_streaming_api_call")
    @patch("harness.run_agent.AIAgent._interruptible_api_call")
