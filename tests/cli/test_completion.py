"""Tests for plutus_cli/completion.py — shell completion script generation."""
...
from harness.cli.completion import _walk, generate_bash, generate_zsh, generate_fish
