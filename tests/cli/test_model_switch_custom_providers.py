...
import harness.cli.providers as providers_mod
from harness.cli.model_switch import list_authenticated_providers, switch_model
from harness.cli.providers import resolve_provider_full
...
def test_list_authenticated_providers_includes_custom_providers(monkeypatch):
    ...
    monkeypatch.setattr("harness.agent.models_dev.fetch_models_dev", lambda: {})
...
def test_switch_model_accepts_explicit_named_custom_provider(monkeypatch):
    ...
    monkeypatch.setattr("harness.cli.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
    monkeypatch.setattr("harness.cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("harness.cli.model_switch.get_model_capabilities", lambda *a, **k: None)
