...
from harness.gateway.config import Platform, StreamingConfig
from harness.gateway.platforms.base import resolve_proxy_url
...
class TestGetProxyUrl:
    ...
    def test_returns_none_when_not_configured(self, monkeypatch):
        ...
        runner = _make_runner()
        with patch("harness.gateway.run._load_gateway_config", return_value={}):
    ...
    def test_reads_from_config_yaml(self, monkeypatch):
        ...
        with patch("harness.gateway.run._load_gateway_config", return_value=cfg):
