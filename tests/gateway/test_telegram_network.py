...
from harness.gateway.platforms import telegram_network as tnet
...
class TestConfigFallbackIps:
    def test_env_var_populates_config_extra(self, monkeypatch):
        from harness.gateway.config import GatewayConfig, Platform, PlatformConfig, _apply_env_overrides
    ...
    def test_env_var_creates_platform_if_missing(self, monkeypatch):
        from harness.gateway.config import GatewayConfig, Platform, _apply_env_overrides
