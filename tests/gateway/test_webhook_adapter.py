...
from harness.gateway.platforms.webhook import (
    WebhookAdapter,
    _INSECURE_NO_AUTH,
...
class TestHTTPHandling:
    ...
    async def test_connect_starts_server(self):
        ...
        with patch("harness.gateway.platforms.webhook.web.AppRunner") as MockRunner, \
             patch("harness.gateway.platforms.webhook.web.TCPSite") as MockSite:
...
class TestCheckRequirements:
    ...
    @patch("harness.gateway.platforms.webhook.AIOHTTP_AVAILABLE", False)
