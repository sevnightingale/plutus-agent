...
class TestGetDefaultModelForProvider:
    """Unit tests for plutus_cli.models.get_default_model_for_provider."""
...
class TestGatewayEmptyModelFallback:
    ...
    def test_empty_model_filled_from_provider(self):
        ...
        with patch("harness.gateway.run._resolve_gateway_model", return_value=""), \
             patch("harness.gateway.run._resolve_runtime_agent_kwargs", return_value={
    ...
    def test_nonempty_model_not_overridden(self):
        ...
        with patch("harness.gateway.run._resolve_gateway_model", return_value="gpt-5.4"), \
             patch("harness.gateway.run._resolve_runtime_agent_kwargs", return_value={
                 "provider": "openai-codex",
                 "api_key": "test-key",
                 "base_url": "https://chatgpt.com/backend-api/codex",
...
class TestResolveGatewayModel:
    ...
    def test_returns_default_key(self):
        from harness.gateway.run import _resolve_gateway_model
